        ...
        <NuxtLayout name="dashboardlayout">
            ...
            <div class="grid grid-cols-2 gap-6 w-full">
                <form class="flex flex-col space-y-4" @submit.prevent="generate">
                    ...
                    <FormGroup type="text" label="What is it?" placeholder="website, article, blog"
                        v-model="form.type" />
                    <FormGroup type="text" label="Enter page title" v-model="form.title" />
                    <FormGroup type="text" label="Enter description.. upto 155 characters is a optimum one"
                ...
                <div class="relative" v-show="code.actual">
                    <button @click="copyCode"
                        class="absolute top-6 right-0 bg-slate-700 text-gray-50 px-2 py-1 rounded-l-md">
                        {{ buttonText }}
                    </button>
                    <pre>
